...
class CoingeckoStats:
    ...
    def coins(self):
        data = self.CG.get_coins_markets(
            vs_currency='eur',
            # uncomment next line and define names to get desired coins
...
class CurrencyConversion:
    def __init__(self):
        self.url = 'https://www.alphavantage.co/query?function=CURRENCY_EXCHANGE_RATE&from_currency=USD&to_currency=EUR&apikey=57J8AV3G9DNMX9NC'
